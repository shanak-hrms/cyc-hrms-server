...
const { appyLeaveRequest, updateLeaveRequest, deleteLeaveRequest, getemployeeLeave, applyForLeave, getPendingLeave, getApprovedLeave, approveLeaveRequest, getApprovedLeaveForUser, getRejectedLeaveForUSer, rejectLeaveRequest, getParticularLeaveByID, getPendingLeaveForUser } = require('../controller/empLeaveCtrl');
...
router.get('/pending/request/foruser',auth,getPendingLeaveForUser);
