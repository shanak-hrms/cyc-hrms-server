...
const { createLead, updateLeadRecords, deleteLeadRecords, getLeadBusinessList, updateLeadStatus, getParticularLeadDetails, requestLeadUpdate, approveLeadUpdateRequest, tagIn, tagOut } = require('../controller/leadBusiness');
...
router.patch('/tagIn/:leadId',auth,tagIn);
router.patch('/tagOut/:leadId',auth,tagOut);
