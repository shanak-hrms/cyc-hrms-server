...
const LeavePolicyUploader: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const res = await axios.post(`${baseURL}/user/leave-policy`, payload, {
                headers: {
...
export default LeavePolicyUploader;
