...
import styles from './ClaimActionModal.module.scss'
import { Modal, Grid, Typography, Box, Divider } from '@mui/material'
import { MdOutlineClose } from "react-icons/md";
import CommonButton from '../../common/CommonButton/CommonButton';


export interface IClaimActionModal {
    open: boolean;
    handleClose: any;
    handleReject: any;
    handleApprove: any
}
const ClaimActionModal = ({ open, handleClose, handleReject, handleApprove }: IClaimActionModal) => {
    return (
        <Modal
            open={open}
